...
import { PhotoCarousel, SpeakerPhoto } from "@/shared/ui/lp-media";
...
export const metadata: Metadata = {
  ...
  description:
    "Palestra presencial no escritório da Utah Investimentos, em Curitiba: oratória voltada a negócios com Diego Endrigo, fundador e CEO da Utah Invest (XP). Realização Liga de Finanças da Universidade Positivo.",
  openGraph: {
    title: "Oratória para Negócios com Diego Endrigo (Utah Invest | XP)",
    description:
      "Evento presencial da LFUP no escritório da Utah Investimentos, em Curitiba, dia 10 de outubro. Vagas garantidas para membros; lista de espera aberta.",
  },
};
    ...
    <div className="min-h-screen bg-black font-sans text-white antialiased selection:bg-white selection:text-black">
      ...
      <main className="mx-auto max-w-5xl px-6">
        ...
        <section className="border-t border-white/15 py-20 md:py-28">
          ...
          <div className="mt-8">
            <PhotoCarousel photos={EVENT_PHOTOS} emptyHint="public/lp/evento/" />
          </div>
        </section>
        ...
        <section
          id="inscricao"
          className="scroll-mt-16 border-t border-white/15 py-20 md:py-28"
        >
          <div className="grid gap-12 md:grid-cols-[1fr_1.2fr] md:gap-20">
            <div>
              ...
              <p className="mt-6 max-w-md leading-relaxed text-white/60">
                Membros da LFUP têm vaga garantida. Quem não é membro entra na
                lista de espera, por ordem de inscrição.
              </p>
            </div>
            <div className="md:pt-2">
              <EventRegistrationForm
                slug="oratoria-para-negocios"
                tone="dark"
                askMember
              />
            </div>
        ...
        <section className="border-t border-white/15 py-24 text-center md:py-32">
          <h2 className="mx-auto max-w-2xl text-3xl font-bold leading-tight md:text-5xl">
            {EVENT.dataHora
              ? `${EVENT.dataHora}. As vagas são limitadas.`
